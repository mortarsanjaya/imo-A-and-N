...
Fix a positive integer $n$ and $c \in R$ non-negative.
...
Then $x_i x_{i + 2}$ equals $c^2$ when $i$ is even and $0$ when $i$ is odd.
Thus, the expression~\eqref{2010a3-eq0} equals $n c^2$.
